        ...
        <div className="containers-sostenibilidad">
            ...
            <div className='sostenibilidad-info'>
                <div className='card-innovacion'>
                    ...
                    <div className="informacion">
                        <p > En MAVRACON, garantizamos operaciones seguras, inclusivas y responsables con el medio ambiente y las comunidades. Nos guiamos por los indicadores ASG (Ambiental, Social y Gobernanza) para mantener nuestro compromiso con la sostenibilidad.</p>
                    </div>
                </div>
            </div>
            ...
            <div className='sostenibilidad-info'>
                <div className='card-innovacion'>
                    ...
                    <p className="">En nuestro enfoque de ingeniería y consultoría, capacitamos a equipos para desarrollar habilidades clave que no solo cubren tareas específicas, sino que promueven su crecimiento integral. Creemos que la sostenibilidad transforma proyectos, carreras y comunidades, impulsando un impacto positivo en cada etapa.</p>
                </div>
            </div>
